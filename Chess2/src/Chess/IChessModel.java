...
public interface IChessModel {
	 ...
	 *  move.fromColumn]} or {@code [move.toRow,
	 *  move.toColumn]} don't represent valid locations on the board.
	 */
	boolean isValidMove(Move move);

	/**
	 * Moves the piece from location {@code [move.fromRow, move.fromCol
	 * umn]} to location {@code [move.fromRow,move.fromColumn]}.
	 *
	 * @param move a {@link W13project3.Move} object describing the move
	 *  to be made.
	 * @throws IndexOutOfBoundsException if either {@code [move.fromRow,
	 *  move.fromColumn]} or {@code [move.toRow,move.toColumn]} 
